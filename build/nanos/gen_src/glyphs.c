#include "glyphs.h"
unsigned int const C_aelf_logo_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_aelf_logo_bitmap[] = {
  0xff, 0xff, 0xff, 0xff, 0x7f, 0xfe, 0x63, 0xfe, 0xe3, 0xff, 0xc3, 0xf3, 0x9f, 0xe1, 0xff, 0xc0,
  0xff, 0xc0, 0x9f, 0xe1, 0xc3, 0xf3, 0xe3, 0xff, 0x63, 0xfe, 0x7f, 0xfe, 0xff, 0xff, 0xff, 0xff,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_aelf_logo = { GLYPH_aelf_logo_WIDTH, GLYPH_aelf_logo_HEIGHT, 1, C_aelf_logo_colors, C_aelf_logo_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
